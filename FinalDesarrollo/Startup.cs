...
namespace FinalDesarrollo
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ctrlCatedraticosContext>(options => options.UseSqlServer(connectionString));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "Catedraticos - API",
                    Version = "v1",
                    Description = "API Catedraticos, Examen Final.",
                    Contact = new OpenApiContact
                    {
                        Name = "Jessica Diaz ",
                        carnet = "5190-14-736 ",
                        Email = "jdiazd6@miumg.edu.gt",
            ...
            {
                DbContextOptions<ctrlCatedraticosContext> dbContextOptions = new DbContextOptionsBuilder<ctrlCatedraticosContext>()
